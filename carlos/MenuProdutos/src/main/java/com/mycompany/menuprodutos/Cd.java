...
public Cd(String descricao, String genero, int estoque, double preco, String artista, String gravadora, String paisDeOrigem, String caminhoImagem) {
    super(descricao, genero, estoque, preco, "CD", caminhoImagem);
