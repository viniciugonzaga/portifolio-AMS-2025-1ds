...
public Livro(String descricao, String genero, int estoque, double preco, String autor, String editora, String edicao, String caminhoImagem) {
    super(descricao, genero, estoque, preco, "LIVROS", caminhoImagem);
    this.autor = autor;
