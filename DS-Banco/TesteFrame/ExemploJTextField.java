...
public class ExemploJTextField extends JFrame {
    ...
    JButton botao, botaoLimpar;
    JLabel rotulo1, rotulo2, rotulo3, rotulo4;
    JTextField texto1, texto2;
    JFormattedTextField texto3, texto4;
    ...
    public ExemploJTextField() {
        ...
        try {
            ...
            texto3 = new JFormattedTextField(mascaraTelefone);
            texto4 = new JFormattedTextField(mascaraCelular);
        ...
        botaoLimpar.setBounds(200, 150, 100, 30);
    ...
    private void limparCampos() {
        texto1.setText("");
        texto2.setText("");
        texto3.setValue(null);
        texto4.setValue(null);
        texto1.requestFocus();
    }
