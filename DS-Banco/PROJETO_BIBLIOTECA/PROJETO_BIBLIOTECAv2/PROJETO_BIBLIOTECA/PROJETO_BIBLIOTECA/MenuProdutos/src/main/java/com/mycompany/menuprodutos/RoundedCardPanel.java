...
public class RoundedCardPanel extends JPanel {
    ...
    private Menu_Produtos menuProdutosReferencia; // Referência para Menu_Produtos

    public RoundedCardPanel(Produto produto, Menu_Produtos menuProdutos) {
        this.produto = produto;
        this.menuProdutosReferencia = menuProdutos; // Recebe a referência de Menu_Produtos
        ...
        comprarButton.addActionListener(e -> {
            Menu menu = new Menu(produto, menuProdutosReferencia); // Usa a referência de Menu_Produtos
